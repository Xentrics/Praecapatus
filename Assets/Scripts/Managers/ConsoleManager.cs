...
namespace Assets.Scripts.Managers
{
    ...
    public class ConsoleManager : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            /* add some globals. Console is a central element. I could use a seperate initiation script though... */
            Constants.chatManager = this; // save global reference
            Constants.HUDCanvas = GameObject.FindGameObjectWithTag("HUD"); // should be the gameobject.gameobject, but may change in the future!
            // get the statusUI in a safe way...
            foreach (var c in Constants.HUDCanvas.GetComponentsInChildren<Component>())
            {
                if (c.name.Equals("StatusUI"))
                {
                    Constants.StatusUI = c.gameObject;
                    break;
                }
            }
        }
        ...
        /**
         * func: add a new text passage to the array of strings and update text box
         * @l non-empty string to add. Linebrakes will be added on need
         */
