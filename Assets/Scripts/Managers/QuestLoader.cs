...
namespace Assets.Scripts.Managers
{
    public static class QuestLoader
    {
         ...
         */
        static List<QuestGoal> ParseGoals(string descs, string types, string datas)
        {
            ...
            string[] dat = null;
            List<QuestGoal> parsedGoals = new List<QuestGoal>(desArr.Length);
         ...
         */
        public static void LoadQuestStatesFromDisk(out List<Quest> acceptedQuests, out HashSet<string> finishedQuests)
        {
         ...
         */
        public static void SaveQuestStatesToDisk(List<Quest> acceptedQuests, HashSet<string> finishedQuests)
        {
